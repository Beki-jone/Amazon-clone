...
const navStateData= useLocation()
  ...
  return (
    <section className={classes.logoIn}>
      <Link to="/">
        <img
      ...
      <div className={classes.login_container}>
        ...
        <form>
          ...
          <button name="signIn" type="submit" onClick={authHandler} className={classes.login_signInButton}>
            {loading.signIn ? <ClipLoader color="#000" size={12} /> : 'Sign In'}
          </button>
        </form>
        <p>
          By signing-in you agree to the AMAZON FAKE CLONE conditions of use and sale. Please see our privacy Notice,
          our cookies Notice, and our Interest-Based Ads Notice.
        </p>
        <button name="signUp" type="submit" onClick={authHandler} className={classes.login_registerButton}>
        {loading.signUp ? <ClipLoader color="#000" size={12} /> : 'Create Your Amazon Account'}
