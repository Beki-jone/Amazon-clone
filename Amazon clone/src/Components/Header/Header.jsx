    ...
    <section className={classes.fixed}> 
        <section>
            ...
            <div className={classes.search}>
                ...
                <select name="" id="" className={classes.all}><option value="">All</option></select>
                ...
                <Link to={!user && '/auth'}>
                    <div>
                     ...
                     (<>
                        ...
                        <select className={classes.acc} value="" onClick={()=>auth.signOut()}> <option >Sign Out</option></select>
                        </> ):(
                        <>
                        <p>Hello,  Sign In</p>
                        <select className={classes.acc}> <option value="" >Account and Lists</option></select>
                        </>)
                        }
                    </div>
